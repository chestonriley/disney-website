    ...
    <div class="secondary-content">
        ...
        <div class="left-content">
            ...
            <div class="para-content">
                ...
                <p>Let's consider a list of potential options.  Click on each to see a list of pros and cons.</p>
                
                <div id="comparison_thumbnails_container">
                    <button class="comparison_thumbnail" id="rental_car_thumbnail">Rental Car pros/cons</button>
                    <button class="comparison_thumbnail" id="bus_system_thumbnail">Bus System pros/cons</button>
                    <button class="comparison_thumbnail" id="taxi_thumbnail">Taxi pros/cons</button>                
                </div>
